...
public class ShoppingCartControllerTest {
    ...
    @DisplayName("Get shopping cart for current user")
    ...
    @Test
    @DisplayName("Get cart without authentication - Should return 401/403")
    ...
    @DisplayName("Access cart with wrong role - Should return 403")
    ...
    @Test
    @WithMockUser(username = "user", roles = {"USER"})
    @DisplayName("Create item with negative quantity - Should return 400")
